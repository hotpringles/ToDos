      ...
      <AnimatePresence>
        {isOpen && (
          <motion.ul
            ...
            className="absolute left-10 z-50 w-32 py-2 bg-white border border-gray-100 rounded-2xl shadow-xl shadow-gray-100/50"
          >
            {categories.map((cat) => (
              <li key={cat}>
                <button
                  ...
                  className="flex items-center justify-between w-full px-4 py-2 text-[12px] font-medium text-slate-600 hover:bg-slate-50 hover:text-indigo-600 transition-colors"
                >
                  {cat}
