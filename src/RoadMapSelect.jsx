...
const RoadMapSelect = ({ roadmaps, setRoadMaps, selected, setSelected }) => {
        ...
        >
          ...
          <div className="flex items-center justify-center w-9 pr-2">
            ...
            <AnimatePresence mode="wait" initial={false}>
              {showCheckMark && showDeleteButton ? (
                // [X 표시]
                <motion.button
                  key="cancel"
